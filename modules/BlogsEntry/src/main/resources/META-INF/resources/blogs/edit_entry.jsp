...
<script data-senna-track="temporary" type="text/javascript" src="<%= request.getContextPath() %>/js/ckeditor/ckeditor.js"></script>
					...
					<aui:fieldset>
							...
							<div class="cover-image-caption <%= (blogsEditEntryDisplayContext.getCoverImageFileEntryId() == 0) ? "invisible d-none" : "d-none" %>">
								<small>
									<textarea 
										...
										id="<%= liferayPortletResponse.getNamespace()%>coverImageCaptionEditor" 
										rows="10"
										cols="80">
										<%= blogsEditEntryDisplayContext.getCoverImageCaption() %>
									</textarea>
						...
						>
							...
							<div class="entry-content form-group">
								<textarea 
									name="<%= liferayPortletResponse.getNamespace()%>contentEditor" 
									id="editorBlog" 
									rows="10"
									cols="80">
...
<script>
	...
	CKEDITOR.replace( '<%= liferayPortletResponse.getNamespace()%>coverImageCaptionEditor', {
		extraPlugins: 'cursivebutton',
		versionCheck: false,
		contentsCss: [
			CKEDITOR.getUrl('contents.css'),
